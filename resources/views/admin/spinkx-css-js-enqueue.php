...
function spinkx_admin_add_inline_js() {
	...
	/*if ( isset($_GET['page']) && $_GET['page'] === 'spinkx_analytics' ) {
		wp_enqueue_script( 'google-chart', "https://www.google.com/jsapi?autoload={'modules':[{'name':'visualization','version':'1.30','packages':['corechart']}]}", array(), null );
	}*/
}
